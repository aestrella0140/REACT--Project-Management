    ...
    >
      <MDBContainer className="p-4">
        <section className="mb-4 ">
          <a
            color="light"
            className="m-3 border btn-outline-light"
            href="#!"
            role="button"
          >
          ...
          <a
            color="light"
            className="m-2 border btn-outline-light"
          ...
          <a
            color="light"
            className="m-3 border btn-outline-light"
            href="https://www.linkedin.com/in/adrian-estrella-7a91b42a2/"
            role="button"
          >
      ...
      <div
        ...
        style={{ backgroundColor: "rgba(0, 0, 0, o.2)" }}
      >
        @ 2024 Copyright:
